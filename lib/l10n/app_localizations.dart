...
abstract class AppLocalizations {
  ...
  /// No description provided for @sectionAlarms.
  ///
  /// In en, this message translates to:
  /// **'Alarms'**
  String get sectionAlarms;
  ...
  /// No description provided for @ringtoneGentle.
  ///
  /// In en, this message translates to:
  /// **'Gentle Chimes'**
  String get ringtoneGentle;

  /// No description provided for @ringtoneRooster.
  ///
  /// In en, this message translates to:
  /// **'Morning Rooster'**
  String get ringtoneRooster;

  /// No description provided for @ringtoneOcean.
  ///
  /// In en, this message translates to:
  /// **'Ocean Waves'**
  String get ringtoneOcean;

  /// No description provided for @resetAllAlarms.
  ///
  /// In en, this message translates to:
  /// **'Reset all alarms'**
  String get resetAllAlarms;

  /// No description provided for @resetAllAlarmsDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @alarmsResetSnack.
  ///
  /// In en, this message translates to:
  /// **'All alarms have been deleted.'**
  String get alarmsResetSnack;
  ...
  /// No description provided for @homeNoSettingsHint.
  ///
  /// In en, this message translates to:
  /// **'Tap the gear icon to open Settings.'**
  String get homeNoSettingsHint;
}
